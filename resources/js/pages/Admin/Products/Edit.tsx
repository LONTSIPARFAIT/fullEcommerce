...
import { AlertCircle, ArrowLeft, Diamond, File, Grid, Images, Layers, List, Pencil, Save, TagIcon, Trash2 } from 'lucide-react';
...
export default function Edit({ product, categories, brands }: Props) {
  ...
  return (
    <ProductLayout 
      title='Edit Product'
      description='Edit Product detail and information.'
      breadcrumbs={breadcrumbs}
      // backUrl={route('admin.products.index')}
      backUrl='admin/products/index'
      icon={<Diamond size={20} className='text-primary dark:text-primary-foreground' />}
